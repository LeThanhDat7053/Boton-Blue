            ...
            <div class="modal-body">
                <form class="rv-form form-download-url">
                    <div id="download-form-wrapper">
                        <div class="mb-3">
                            <label class="form-label fw-bold">{{ __('Media type') }}</label>
                            <select class="form-control form-select" id="download-url-type">
                                <option value="auto">{{ __('Auto detect') }}</option>
                                <option value="video">{{ __('Video (YouTube, Vimeo...)') }}</option>
                                <option value="vr360">{{ __('VR360 Panorama') }}</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <textarea

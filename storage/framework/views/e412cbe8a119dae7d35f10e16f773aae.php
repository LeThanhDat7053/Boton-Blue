...
>
    <?php if(in_array(Route::currentRouteName(), ['pages.create', 'pages.edit']) &&
...
<?php $component->withAttributes(['class' => 'mt-n2 text-truncate']); ?>
                <?php echo e(trans('packages/slug::slug.preview')); ?>: <a
                    href="<?php echo e($previewURL); ?>"
                    target="_blank"
                ><?php echo e($previewURL); ?></a>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\laragon\www\main\platform\packages\slug\/resources/views/permalink.blade.php ENDPATH**/ ?>
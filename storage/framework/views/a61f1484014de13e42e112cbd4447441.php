...
<?php endif; ?>
        <span class="badge bg-red text-red-fg badge-pill"><?php echo e(number_format(count($bookings))); ?></span>
    </button>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo BaseHelper::clean(trans('plugins/hotel::booking.new_booking_notice', ['count' => count($bookings)])); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <a href="<?php echo e(route('booking.index')); ?>"><?php echo e(trans('plugins/hotel::booking.view_all')); ?></a>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            >
                <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('booking.edit', $booking->id)); ?>" class="text-decoration-none">
                        <div class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <img
                                        class="avatar"
                                        src="<?php echo e(\Botble\Base\Supports\Gravatar::image($booking->address->email)); ?>"
                                        alt="<?php echo e($booking->address->full_name); ?>"
                                    >
                                </div>
                                <div class="col align-items-center">
                                    <p class="text-truncate mb-2">
                                        ...
                                        <time
                                            ...
                                            title="<?php echo e($createdAt = BaseHelper::formatDateTime($booking->created_at)); ?>"
                                    ...
                                    <p class="text-secondary text-truncate mt-n1 mb-0">
                                        <?php echo e(implode(' - ', [$booking->address->phone, $booking->address->email])); ?>
...
<?php /**PATH C:\laragon\www\main\platform\plugins\hotel\/resources/views/notification.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::alert','data' => ['type' => 'warning','important' => true,'class' => \Illuminate\Support\Arr::toCssClasses([
        'alert-license alert-sticky small bg-warning text-white',
        'vertical-wrapper' => AdminAppearance::isVerticalLayout(),
    ]),'icon' => '','style' => \Illuminate\Support\Arr::toCssStyles(['display: none' => $hidden ?? true]),'dataBbToggle' => 'license-reminder']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','important' => true,'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses([
        'alert-license alert-sticky small bg-warning text-white',
        'vertical-wrapper' => AdminAppearance::isVerticalLayout(),
    ])),'icon' => '','style' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssStyles(['display: none' => $hidden ?? true])),'data-bb-toggle' => 'license-reminder']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main\platform\core\base\/resources/views/system/license-invalid.blade.php ENDPATH**/ ?>
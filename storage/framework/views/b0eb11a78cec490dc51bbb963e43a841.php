...
<?php endif; ?>
                                <?php if($plugin->description): ?>
                                    <p
                                        ...
                                        title="<?php echo e($plugin->description); ?>"
                                    >
                                ...
                                <?php if(!config('packages.plugin-management.general.hide_plugin_author', false) && $plugin->author): ?>
                                    <div class="col-12 col-lg">
                                        ...
                                        <?php if(!empty($plugin->url)): ?>
                                            <a
                                                href="<?php echo e($plugin->url); ?>"
                                                target="_blank"
                                                class="fw-bold"
                                            ><?php echo e($plugin->author); ?></a>
                                        <?php else: ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\main\platform\packages\plugin-management\/resources/views/index.blade.php ENDPATH**/ ?>
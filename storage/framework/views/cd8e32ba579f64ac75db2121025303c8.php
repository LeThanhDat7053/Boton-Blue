...
<?php endif; ?>
        ...
        <div class="page-url-seo">
            <p><?php echo e(!empty($object->id) && $object->url ? url(apply_filters(FILTER_SLUG_PREFIX, SlugHelper::getPrefix($object::class), $object)) . '/' . $object->slug : '-'); ?>
        ...
        <div>
            <span
                style="color: #70757a;"><?php echo e(!empty($object->id) && $object->created_at ? $object->created_at->format('M d, Y') : Carbon\Carbon::now()->format('M d, Y')); ?>
...
<?php /**PATH C:\laragon\www\main\platform\packages\seo-helper\/resources/views/meta-box.blade.php ENDPATH**/ ?>